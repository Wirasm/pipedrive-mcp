...
def mock_pipedrive_client():
    ...
    # Set up mock responses for create_person
...
class TestCreatePersonTool:
    ...
    async def test_create_person_success(self, mock_pipedrive_client):
        ...
        mock_pipedrive_client.create_person.assert_called_once()
        call_kwargs = mock_pipedrive_client.create_person.call_args.kwargs
    ...
    async def test_create_person_invalid_id(self, mock_pipedrive_client):
        ...
        mock_pipedrive_client.create_person.assert_not_called()
    ...
    async def test_create_person_api_error(self, mock_pipedrive_client):
        ...
        mock_pipedrive_client.create_person.side_effect = api_error
